...
export default function ProfilePage() {
  ...
  // Datos de ejemplo ficticios para demostración
  const [userData, setUserData] = useState({
    name: 'Carlos Mendoza',
    email: 'carlos.mendoza@ejemplo.cl',
    phone: '+56 9 5555 4321',
    region: 'Región Metropolitana',
    address: 'Av. Las Condes 1234, Depto 402'
  });
    ...
    <div className="bg-white font-sans text-gray-800 w-full min-h-screen">
      ...
      <div className="relative h-48 w-full flex flex-col items-center justify-center bg-[#F9F1E7]">
        <div className="relative z-10 text-center">
          ...
          <h1 className="text-3xl font-semibold text-black">Mi Cuenta</h1>
          <p className="mt-1 text-sm text-gray-600">
            <Link href="/" className="font-bold text-black hover:underline">Inicio</Link> &gt; <span className="text-gray-500">Perfil</span>
          </p>
        </div>
      </div>
        ...
        <div className="bg-[#F9F1E7] border border-gray-200 rounded-2xl p-8 shadow-sm">
          ...
          <div className="pt-8 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-500 mb-1">Región / Ubicación</label>
                <input
                  type="text"
                  disabled={!isEditing}
